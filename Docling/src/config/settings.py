...
# Enable Docling for enhanced document processing
USE_DOCLING = True
...
DOCLING_CONFIG = {
    ...
    'timeout_per_doc': 300,      # Seconds per document
    'retry_on_failure': True,
    'max_retries': 2,
}

# Docling output directories
DOCLING_OUTPUT = {
    'images_dir': '.docling_images',
    'tables_dir': '.docling_tables',
...
# Chunk type priorities (for retrieval)
CHUNK_TYPE_WEIGHTS = {
    'text': 1.0,
    'table': 1.2,       # Boost tables slightly
    'image': 0.8,       # Images with OCR text
    'heading': 1.1,     # Section headers
}

# Elements to keep together (no splitting)
ATOMIC_ELEMENTS = [
    'table',
    'formula',
    'equation',
